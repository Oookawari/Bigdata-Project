 ...
 * @Version: 1.0
 */
public class AnalysisTextTool2 implements Tool {
    @Override
    public int run(String[] args) throws Exception {
        //获取job
        Job job= Job.getInstance();
        //设置jar位置
        job.setJarByClass(AnalysisTextTool2.class);
        //扫描主叫列族
        Scan scan=new Scan();
        ...
        TableMapReduceUtil.initTableMapperJob(
                ...
                scan,
                AnalysisTextMapper2.class,
                Text.class,
                Text.class,
                job
        );
        //设置reducer
        job.setReducerClass(AnalysisTextReducer2.class);
